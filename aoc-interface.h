 ...
 *
 *   hash: 07555fee5d7a3ea0a237f7834be857904129f892
 *
...
enum AOC_COMMAND {
  ...
  CMD_AUDIO_INPUT_MODEM_INPUT_START_ID = 210, /* [0x00d2] ->  struct CMD_HDR */
  ...
  CMD_AUDIO_OUTPUT_CFG_HAPTICS_ID = 225, /* [0x00e1] ->  struct CMD_AUDIO_OUTPUT_CFG_HAPTICS */
  CMD_AUDIO_INPUT_MIC_RECORD_AP_STOP_ID = 226, /* [0x00e2] ->  struct CMD_HDR */
  CMD_AUDIO_OUTPUT_CFG_SIGGEN_ID = 226, /* [0x00e2] ->  struct CMD_AUDIO_OUTPUT_CFG_SIGGEN */
  ...
  CMD_USB_CONTROL_GET_XHCI_VERSION_ID = 229, /* [0x00e5] ->  struct CMD_USB_CONTROL_GET_XHCI_VERSION */
  CMD_AUDIO_INPUT_MIC_LOOPBACK_STOP_ID = 230, /* [0x00e6] ->  struct CMD_HDR */
  CMD_AUDIO_OUTPUT_GET_EP_CUR_SAMPLES_ID = 231, /* [0x00e7] ->  struct CMD_AUDIO_OUTPUT_GET_EP_SAMPLES */
  CMD_AUDIO_INPUT_SPATIAL_START_ID = 231, /* [0x00e7] ->  struct CMD_HDR */
  CMD_AUDIO_OUTPUT_GET_EP_TOT_SAMPLES_ID = 232, /* [0x00e8] ->  struct CMD_AUDIO_OUTPUT_GET_EP_SAMPLES */
  CMD_AUDIO_INPUT_SPATIAL_STOP_ID = 232, /* [0x00e8] ->  struct CMD_HDR */
  CMD_AUDIO_OUTPUT_DECODE_FLUSH_RB_ID = 233, /* [0x00e9] ->  struct CMD_HDR */
  CMD_AUDIO_INPUT_SET_PARAMETER_ID = 233, /* [0x00e9] ->  struct CMD_AUDIO_INPUT_SET_PARAMETER */
  CMD_AUDIO_OUTPUT_GET_DSP_STATE_ID = 234, /* [0x00ea] ->  struct CMD_AUDIO_OUTPUT_GET_DSP_STATE */
  CMD_AUDIO_INPUT_SET_PARAMETER_BULK_ID = 234, /* [0x00ea] ->  struct CMD_AUDIO_INPUT_SET_PARAMETER_BULK */
  CMD_AUDIO_OUTPUT_GET_SINK_PROCESSING_STATE_ID = 235, /* [0x00eb] ->  struct CMD_AUDIO_OUTPUT_GET_SINK_PROCESSING_STATE */
  CMD_AUDIO_INPUT_GET_PARAMETER_ID = 235, /* [0x00eb] ->  struct CMD_AUDIO_INPUT_GET_PARAMETER */
  CMD_USB_CONTROL_SETUP_ID = 236, /* [0x00ec] ->  struct CMD_USB_CONTROL_SETUP */
  CMD_AUDIO_INPUT_GET_PARAMETER_BULK_ID = 236, /* [0x00ec] ->  struct CMD_AUDIO_INPUT_GET_PARAMETER_BULK */
  CMD_USB_CONTROL_STATUS_GET_ID = 237, /* [0x00ed] ->  struct CMD_USB_CONTROL_STATUS_GET */
  ...
  CMD_USB_CONTROL_GET_DEVICE_CONTEXT_ID = 239, /* [0x00ef] ->  struct CMD_USB_CONTROL_GET_DEVICE_CONTEXT */
  CMD_AUDIO_INPUT_GET_MODULES_ID = 239, /* [0x00ef] ->  struct CMD_AUDIO_INPUT_GET_MODULES */
  CMD_USB_CONTROL_GET_TR_DEQ_PTR_ID = 240, /* [0x00f0] ->  struct CMD_USB_CONTROL_GET_TR_DEQ_PTR */
  CMD_AUDIO_INPUT_HOTWORD_TEST_TRIGGER_ID = 240, /* [0x00f0] ->  struct CMD_HDR */
  CMD_USB_CONTROL_NOTIFY_CONN_STAT_ID = 241, /* [0x00f1] ->  struct CMD_USB_CONTROL_NOTIFY_CONN_STAT */
  CMD_AUDIO_INPUT_HOTWORD_DETECTED_ID = 241, /* [0x00f1] ->  struct CMD_HDR */
 ...
 *   CMD_AUDIO_INPUT_HOTWORD_DETECTED_ID, UUID: 912cdaed09db28710cfd86adc3dd27b0
 */
struct CMD_HDR {
 ...
 * Structure associated with the following commands:
 *
 *   CMD_USB_CONTROL_SETUP_ID, UUID: 8dbb0d7b8a2de8b27332451ce64e5861
 */
 ...
 * Structure associated with the following commands:
 *
 *   CMD_USB_CONTROL_STATUS_GET_ID, UUID: ab6cea07484cd1b192dfa77f34699486
 */
 ...
 * Structure associated with the following commands:
 *
 *   CMD_USB_CONTROL_GET_DEVICE_CONTEXT_ID, UUID: 512f6c2016b45a2f4a8d9a74cc362309
 */
 ...
 * Structure associated with the following commands:
 *
 *   CMD_USB_CONTROL_GET_TR_DEQ_PTR_ID, UUID: 881d6266bb20cfd333a72a28c6b984d3
 */
 ...
 * Structure associated with the following commands:
 *
 *   CMD_USB_CONTROL_NOTIFY_CONN_STAT_ID, UUID: f6c20b45703ebd9184e7d339255157ea
 */
...
inline int AocInterfaceCheck(const void * addr, int size) {
  static const uint8_t uuid_array[AOC_UUID_ENTRIES][AOC_UUID_SIZE] = { 
      ...
      { 0x51, 0x2f, 0x6c, 0x20, 0x16, 0xb4, 0x5a, 0x2f, 0x4a, 0x8d, 0x9a, 0x74, 0xcc, 0x36, 0x23, 0x09},
      ...
      { 0x88, 0x1d, 0x62, 0x66, 0xbb, 0x20, 0xcf, 0xd3, 0x33, 0xa7, 0x2a, 0x28, 0xc6, 0xb9, 0x84, 0xd3},
      { 0x88, 0xe8, 0x74, 0xb0, 0xbf, 0x91, 0x2e, 0xaa, 0x12, 0xc9, 0x85, 0x25, 0x2e, 0x24, 0xb3, 0x26},
      { 0x8d, 0xbb, 0x0d, 0x7b, 0x8a, 0x2d, 0xe8, 0xb2, 0x73, 0x32, 0x45, 0x1c, 0xe6, 0x4e, 0x58, 0x61},
      { 0x90, 0xd9, 0x24, 0x60, 0x10, 0x4e, 0x4b, 0xc6, 0xc2, 0xd9, 0xc9, 0xa0, 0xf6, 0x35, 0xb5, 0xc9},
      { 0x91, 0x2c, 0xda, 0xed, 0x09, 0xdb, 0x28, 0x71, 0x0c, 0xfd, 0x86, 0xad, 0xc3, 0xdd, 0x27, 0xb0},
      ...
      { 0xab, 0x6c, 0xea, 0x07, 0x48, 0x4c, 0xd1, 0xb1, 0x92, 0xdf, 0xa7, 0x7f, 0x34, 0x69, 0x94, 0x86},
      ...
      { 0xf6, 0xc2, 0x0b, 0x45, 0x70, 0x3e, 0xbd, 0x91, 0x84, 0xe7, 0xd3, 0x39, 0x25, 0x51, 0x57, 0xea},
